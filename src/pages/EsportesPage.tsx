    ...
    <div className="min-h-screen bg-background pb-24 pt-16">
      ...
      <div className="sticky top-16 z-20 bg-background">
        ...
        >
          ...
          <span className="font-display brand-title text-lg font-extrabold uppercase tracking-wide text-foreground">
            {selectedSport.label}
          </span>
              ...
              <div className="mt-2">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-display brand-title text-lg font-extrabold uppercase">Eventos Populares</h3>
                  </div>
